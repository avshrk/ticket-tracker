...
user = User.create!(name: "Bridge Builder", email: "bridge.builder@domain.test", password: "bridges")
passenger = User.create!(name: "Train Passenger", email: "train.passenger@domain.test", password: "bridges")
